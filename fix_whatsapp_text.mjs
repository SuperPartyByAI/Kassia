...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; margin-top: 1rem;">
  ...
  <div style="background: #f8fafc; padding: 1.5rem; border-radius: 12px; border-left: 4px solid #10b981; display: flex; flex-direction: column;">
    ...
    <a href="${whatsappLink}" target="_blank" rel="noopener noreferrer" style="font-size: 0.9rem; color: #10b981; text-decoration: none; font-weight: 600; align-self: flex-start;">Scrie-ne pe WhatsApp pentru Berceni &rarr;</a>
  </div>
</div>
  `;
  ...
  if (sections && sections.length > 0) {
      ...
      console.log("Updated Ilfov CTA text to 'Scrie-ne pe WhatsApp pentru Berceni' successfully!");
  }
})();
