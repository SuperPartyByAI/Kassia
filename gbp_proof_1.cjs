...
// Ensure editprofile modal is open or reopen it
runAppleScript(`
...
tell application "Google Chrome"
    ...
    (function() {
        ...
        if (descDiv) {
            ...
            if (parent.innerText.includes('ÎN AȘTEPTARE') || parent.innerText.includes('PENDING')) descStatus = 'PENDING';
...
`;
console.log(runAppleScript(extractProofJs));
