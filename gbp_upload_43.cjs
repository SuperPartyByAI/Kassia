...
// 2. Focus pe butonul "Selectează imagini" și Space
runAppleScript(`
tell application "Google Chrome"
    execute active tab of first window javascript "
    (function() {
...
tell application "System Events"
    ...
    -- Introducem calea către folderul de 43
    keystroke "/Users/universparty/Desktop/KASSIA_GBP_UPLOAD_43_READY"
    delay 1
...
console.log("Upload 43 initiated.");
