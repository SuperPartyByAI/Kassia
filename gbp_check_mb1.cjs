...
`;
console.log("SETUP: " + runAppleScript(setupJs));
...
tell application "Google Chrome"
    ...
    (function() {
        ...
        imgs.forEach(img => {
            ...
            if (identifier && identifier.length > 5) win.my_unique_thumbnails.add(identifier);
        });
...
execSync('screencapture -x /Users/universparty/Desktop/gbp_photos_proof_mb1.png');
