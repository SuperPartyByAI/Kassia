  ...
  const sections = [
    {
      ...
      content: {
        body: "Organizăm petreceri interactive, adaptate în funcție de spațiu și vârsta copiilor. Venim cu energia și recuzita potrivite indiferent dacă evenimentul are loc în mediul urban sau în zona metropolitană.",
