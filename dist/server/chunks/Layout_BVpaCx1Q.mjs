...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Header;
  const { whatsappMessage, isAnimatori } = Astro2.props;
  ...
  if (!whatsappText) {
    if (isAnimatori || isAnimatoriPage) {
...
const $$GlobalFloatingCTA = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (!whatsappText) {
    if (isAnimatori) {
      ...
      whatsappText = config.whatsapp_text || "Buna! As dori mai multe detalii";
    }
  }
  const phoneClean = phone.replace(/[^0-9]/g, "");
  const whatsappNumber = phoneClean.startsWith("0") ? "4" + phoneClean : phoneClean;
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(whatsappText)}`;
  const catalogHref = "/catalog-costume/";
  return renderTemplate`${maybeRenderHead()}<div class="global-floating-cta desktop-cta" data-astro-cid-sivwod7a> <div class="cta-stack" data-astro-cid-sivwod7a> <a${addAttribute(catalogHref, "href")} class="cta-btn cta-catalog" aria-label="Vezi catalogul de costume și personaje pentru petreceri copii" data-astro-cid-sivwod7a> <svg class="cta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-sivwod7a> <path d="M2 12a5 5 0 0 0 5 5 8 8 0 0 1 5 2 8 8 0 0 1 5-2 5 5 0 0 0 5-5V7h-5a8 8 0 0 0-8 0H2v5Z" data-astro-cid-sivwod7a></path> <circle cx="6" cy="11" r="2" data-astro-cid-sivwod7a></circle> <circle cx="18" cy="11" r="2" data-astro-cid-sivwod7a></circle> </svg> <span data-astro-cid-sivwod7a>Catalog costume</span> </a> <a${addAttribute(whatsappLink, "href")} class="cta-btn cta-whatsapp" target="_blank" rel="noopener" aria-label="Scrie pe WhatsApp către Kassia" data-astro-cid-sivwod7a> <svg class="cta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-sivwod7a> <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" data-astro-cid-sivwod7a></path> </svg> <span data-astro-cid-sivwod7a>WhatsApp</span> </a> <a${addAttribute(`tel:${phoneClean}`, "href")} class="cta-btn cta-call" aria-label="Sună Kassia" data-astro-cid-sivwod7a> <svg class="cta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-sivwod7a> <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" data-astro-cid-sivwod7a></path> </svg> <span data-astro-cid-sivwod7a>Sună</span> </a> </div> </div> <div class="global-floating-cta mobile-cta" data-astro-cid-sivwod7a> <div class="cta-bar" data-astro-cid-sivwod7a> <a${addAttribute(catalogHref, "href")} class="cta-btn cta-catalog" aria-label="Vezi catalogul de costume și personaje pentru petreceri copii" data-astro-cid-sivwod7a> <svg class="cta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-sivwod7a> <path d="M2 12a5 5 0 0 0 5 5 8 8 0 0 1 5 2 8 8 0 0 1 5-2 5 5 0 0 0 5-5V7h-5a8 8 0 0 0-8 0H2v5Z" data-astro-cid-sivwod7a></path> <circle cx="6" cy="11" r="2" data-astro-cid-sivwod7a></circle> <circle cx="18" cy="11" r="2" data-astro-cid-sivwod7a></circle> </svg> <span data-astro-cid-sivwod7a>Costume</span> </a> <a${addAttribute(whatsappLink, "href")} class="cta-btn cta-whatsapp" target="_blank" rel="noopener" aria-label="Scrie pe WhatsApp către Kassia" data-astro-cid-sivwod7a> <svg class="cta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-sivwod7a> <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" data-astro-cid-sivwod7a></path> </svg> <span data-astro-cid-sivwod7a>WhatsApp</span> </a> <a${addAttribute(`tel:${phoneClean}`, "href")} class="cta-btn cta-call" aria-label="Sună Kassia" data-astro-cid-sivwod7a> <svg class="cta-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-sivwod7a> <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" data-astro-cid-sivwod7a></path> </svg> <span data-astro-cid-sivwod7a>Sună</span> </a> </div> </div> `;
}, "/opt/kassia-site/src/components/GlobalFloatingCTA.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$Layout;
  const { title, description, canonical, robots = "index, follow", schemas = [], ogImage, isAnimatori = false, whatsappMessage } = Astro2.props;
  const schemaGraph = schemas.map((schema) => {
  ...
  return renderTemplate`<html lang="ro"> <head><meta charset="UTF-8"><meta name="google-site-verification" content="tYYr4DkXrfYAVYO5EDy1Kyq0282U7AQTPyBBM9ecaPA"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><title>${title}</title><meta name="description"${addAttribute(description, "content")}><meta name="robots"${addAttribute(robots, "content")}>${canonical && renderTemplate`<link rel="canonical"${addAttribute(canonical, "href")}>`}<meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}>${canonical && renderTemplate`<meta property="og:url"${addAttribute(canonical, "content")}>`}<meta property="og:type" content="website">${ogImage && renderTemplate`<meta property="og:image"${addAttribute(ogImage, "content")}>`}<meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"${addAttribute(title, "content")}><meta name="twitter:description"${addAttribute(description, "content")}>${ogImage && renderTemplate`<meta name="twitter:image"${addAttribute(ogImage, "content")}>`}<meta name="generator"${addAttribute(Astro2.generator, "content")}>${schemaGraph.length > 0 && renderTemplate(_a || (_a = __template(['<script type="application/ld+json">', "<\/script>"])), unescapeHTML(schemaJson))}${renderHead()}</head> <body> ${renderComponent($$result, "Header", $$Header, { "whatsappMessage": whatsappMessage, "isAnimatori": isAnimatori })} <main> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "GlobalFloatingCTA", $$GlobalFloatingCTA, { "isAnimatori": isAnimatori, "whatsappMessage": whatsappMessage })}</body></html>`;
}, "/opt/kassia-site/src/layouts/Layout.astro", void 0);
