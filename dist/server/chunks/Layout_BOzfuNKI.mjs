...
}, "/Users/universparty/wa-web-launcher/kassia-site/src/components/GlobalFloatingCTA.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  })))}${renderHead()}</head> <body> ${renderComponent($$result, "Header", $$Header, {})} <main> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "GlobalFloatingCTA", $$GlobalFloatingCTA, {})}</body></html>`;
