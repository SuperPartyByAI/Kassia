...
import 'clsx';
import { r as renderScript } from './Layout_DxnDXBJj.mjs';
...
const $$ReviewsCarousel = createComponent(($$result, $$props, $$slots) => {
  const reviews = [
    ...
    },
    {
      ...
      date: "Acum 4 ani",
      service: "animatori",
      text: "Rapunzel a fost o prezență caldă și dulce, fetițele au fost absolut fascinate de povestea ei.",
