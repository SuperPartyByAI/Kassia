...
# Function to execute JS in the active tab of Chrome via AppleScript
run_js() {
  local js_code="$1"
...
screencapture -x homepage_indexing_proof.png
...
screencapture -x sector1_indexing_proof.png
