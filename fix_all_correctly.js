...
const correctNames = [
  ...
  { index: 2, title: "Zoue (K-Pop Demon Hunters)" },
  { index: 3, title: "Clăuniță Veselă" },
  { index: 4, title: "Prințesa Aurora" },
  { index: 5, title: "Batman" },
  { index: 6, title: "Costum Leu" },
  { index: 7, title: "Prințesa Belle" },
  { index: 8, title: "Costum Pisicuță" },
  { index: 9, title: "Venom" },
  { index: 10, title: "Catboy (Eroi în Pijama)" },
  { index: 11, title: "Chase (Patrula Cățelușilor)" },
  { index: 12, title: "Mascotă Șoricel" },
  { index: 13, title: "Prințesa Cenușăreasa" },
  { index: 14, title: "Ahri (K-Pop)" },
  { index: 15, title: "Prințesa Elena din Avalor" },
  { index: 16, title: "Prințesa Elsa (Frozen)" },
  { index: 17, title: "Dansatoare Spaniolă" }, // Was Minnie Mouse incorrectly
  ...
  { index: 26, title: "Mira (K-Pop Demon Hunters)" },
...
async function run() {
  ...
  console.log('Fixed ALL cards 1-36 correctly in DB.');
}
