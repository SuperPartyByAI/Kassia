...
(async () => {
  const { data: sections } = await supabase.from('kassia_page_sections').select('id, section_type, title, heading, order_index, content').eq('page_id', '160e370f-0540-4501-b50f-62f88b6c8e83').order('order_index');
  
  if (!sections) { console.log("NO SECTIONS FOUND"); return; }
