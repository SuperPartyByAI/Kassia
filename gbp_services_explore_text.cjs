...
const appleScriptPath = '/tmp/explore_services_text.scpt';
...
fs.writeFileSync('/tmp/gbp_services_text.txt', rawOutput);
console.log("Page text saved to /tmp/gbp_services_text.txt");
