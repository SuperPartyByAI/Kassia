...
const appleScriptPath = '/tmp/explore_services_correct.scpt';
    ...
    repeat with w in windows
        repeat with t in tabs of w
            ...
            if u starts with "https://www.google.com/search" then
                set has_nmx to execute t javascript "document.documentElement.outerHTML.toLowerCase().includes('editează profilul') || document.documentElement.outerHTML.toLowerCase().includes('edit profile')"
...
fs.writeFileSync('/tmp/gbp_services_modal_correct.html', rawOutput);
console.log("Modal HTML saved to /tmp/gbp_services_modal_correct.html");
