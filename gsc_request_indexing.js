...
async function requestIndexing(url) {
    ...
    if (clicked) {
        // Wait for the modal "Indexing Requested" to close
...
async function main() {
    await requestIndexing('https://www.kassia.ro/');
    await requestIndexing('https://www.kassia.ro/animatori-petreceri-copii-sector-1/');
}
