export const SITE_ORIGIN = 'https://www.kassia.ro';
...
export const KNOWN_GONE_PATHS = new Set([
  '/sitemap-index.xml',
  '/sitemap-index.xml/',
  '/sitemap_index.xml',
  '/sitemap_index.xml/'
