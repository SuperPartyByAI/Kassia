...
// Click Planificare edit button
let clickPlanificareJs = `
tell application "Google Chrome"
    ...
    (function() {
        ...
        let btn = btns.find(b => (b.getAttribute('aria-label') || '').includes('Planificare'));
        if (btn) {
            btn.click();
            return 'CLICKED_PLANIFICARE';
        }
        return 'NO_BTN';
    })();"
end tell
`;
console.log(runAppleScript(clickPlanificareJs));
execSync('sleep 2');
